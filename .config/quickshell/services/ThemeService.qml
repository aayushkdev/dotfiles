...
Singleton {
    ...
    readonly property string zenBrowserProfilePath: Config.zenBrowserProfilePath || (Quickshell.env("HOME") + "/.config/zen/mqqv2bt2.Default (release)")
    // GTK/Qt paths
    ...
    function _applyThemeData(themeName, data) {
        var effectivePalette = data.palette || root.palette;
        ...
        // 9. Apply browser theme support for Zen profiles
        _applyBrowserTheme(effectivePalette);

        // 10. Apply GTK/Qt colors from palette
    ...
    function _applyBrowserTheme(pal) {
        if (!pal)
            return;
        ...
        const themeCssLines = [
            ...
            "",
            "@media (prefers-color-scheme: " + (isDarkMode ? "dark" : "light") + ") {",
            "  :root {",
            "    --zen-colors-primary: " + pal.background + " !important;",
            "    --zen-primary-color: " + pal.accent + " !important;",
            "    --zen-colors-secondary: " + pal.background + " !important;",
            "    --zen-colors-tertiary: " + pal.blueDark + " !important;",
            "    --zen-colors-border: " + pal.accent + " !important;",
            "    --toolbarbutton-icon-fill: " + pal.accent + " !important;",
            "    --lwt-text-color: " + pal.text + " !important;",
            "    --toolbar-field-color: " + pal.text + " !important;",
            "    --tab-selected-textcolor: " + pal.text + " !important;",
            "    --toolbar-field-focus-color: " + pal.text + " !important;",
            "    --toolbar-color: " + pal.text + " !important;",
            "    --newtab-text-primary-color: " + pal.text + " !important;",
            "    --arrowpanel-color: " + pal.text + " !important;",
            "    --arrowpanel-background: " + pal.surface1 + " !important;",
            "    --sidebar-text-color: " + pal.text + " !important;",
            "    --lwt-sidebar-text-color: " + pal.text + " !important;",
            "    --lwt-sidebar-background-color: " + pal.blueDark + " !important;",
            "    --toolbar-bgcolor: " + pal.surface0 + " !important;",
            "    --newtab-background-color: " + pal.surface1 + " !important;",
            "    --zen-themed-toolbar-bg: " + pal.background + " !important;",
            "    --zen-main-browser-background: " + pal.background + " !important;",
            "    --toolbox-bgcolor-inactive: " + pal.background + " !important;",
            "    color-scheme: " + (isDarkMode ? "dark" : "light") + ";",
            "  }",
            "",
            "  #permissions-granted-icon {",
            "    color: " + pal.background + " !important;",
            "  }",
            "",
            "  .sidebar-placesTree {",
            ...
            "",
            "  #TabsToolbar {",
            "    background-color: " + pal.blueDark + " !important;",
            "  }",
            "",
            "  .urlbar-background {",
            "    background-color: " + pal.background + " !important;",
            ...
            "    background: " + pal.background + " !important;",
            "  }",
            "",
            "  #zen-media-controls-toolbar #zen-media-progress-bar::-moz-range-track {",
            "    background: " + pal.surface0 + " !important;",
            "  }",
            "",
            "  toolbar .toolbarbutton-1:not([disabled]):is([open], [checked]) > :is(.toolbarbutton-icon, .toolbarbutton-text, .toolbarbutton-badge-stack) {",
            "    fill: " + pal.background + " !important;",
            "  }",
            "",
            "  .identity-color-blue {",
            "    --identity-tab-color: " + pal.accent + " !important;",
            "    --identity-icon-color: " + pal.accent + " !important;",
            "  }",
            "",
            "  .identity-color-turquoise {",
            "    --identity-tab-color: " + pal.success + " !important;",
            "    --identity-icon-color: " + pal.success + " !important;",
            "  }",
            "",
            ...
            "    --identity-tab-color: " + pal.warning + " !important;",
            "    --identity-icon-color: " + pal.warning + " !important;",
            "  }",
            "",
            ...
            "",
            "  .identity-color-red {",
            "    --identity-tab-color: " + pal.error + " !important;",
            "    --identity-icon-color: " + pal.error + " !important;",
            "  }",
            "",
            "  .identity-color-pink {",
            "    --identity-tab-color: " + pal.error + " !important;",
        ...
        const themeCss = themeCssLines.join("\n");

        const userJsLines = [
            "// LYNE_THEME_BEGIN",
            "user_pref(\"toolkit.legacyUserProfileCustomizations.stylesheets\", true);",
            "user_pref(\"zen.theme.accent-color\", \"" + pal.accent + "\");",
        ...
        const userContentLines = [
            ...
            "    :root {",
            "      --in-content-page-color: " + pal.text + " !important;",
            "      --color-accent-primary: " + pal.accent + " !important;",
            "      --color-accent-primary-hover: " + pal.surface2 + " !important;",
            "      --color-accent-primary-active: " + pal.surface1 + " !important;",
            "      background-color: " + pal.background + " !important;",
            "      --in-content-page-background: " + pal.background + " !important;",
            "    }",
            "  }",
            "",
            ...
            "    :root {",
            "      --newtab-background-color: " + pal.background + " !important;",
            "      --newtab-background-color-secondary: " + pal.blueDark + " !important;",
            "      --newtab-element-hover-color: " + pal.surface0 + " !important;",
            "      --newtab-text-primary-color: " + pal.text + " !important;",
            "      --newtab-wordmark-color: " + pal.text + " !important;",
            "      --newtab-primary-action-background: " + pal.accent + " !important;",
            "    }",
            "",
            "    .icon {",
            "      color: " + pal.accent + " !important;",
            ...
            "      background: url(\"zen-logo-mocha.svg\") no-repeat center !important;",
            ...
            "    :root {",
            "      --zen-colors-tertiary: " + pal.blueDark + " !important;",
            "      --in-content-text-color: " + pal.text + " !important;",
            "      --link-color: " + pal.accent + " !important;",
            "      --link-color-hover: " + pal.surface2 + " !important;",
            "      --zen-colors-primary: " + pal.background + " !important;",
            "      --in-content-box-background: " + pal.background + " !important;",
            "      --zen-primary-color: " + pal.accent + " !important;",
            "    }",
            "",
            "    groupbox, moz-card {",
            ...
            "    :root {",
            "      --zen-dark-color-mix-base: " + pal.blueDark + " !important;",
            "      --background-color-box: " + pal.background + " !important;",
            "    }",
            "  }",
            "",
            ...
            "    :root {",
            "      --zen-primary-color: " + pal.surface1 + " !important;",
            "      --social-color: " + pal.accent + " !important;",
            "      --coockie-color: " + pal.surface2 + " !important;",
            "      --fingerprinter-color: " + pal.warning + " !important;",
            "      --cryptominer-color: " + pal.subtext + " !important;",
            "      --tracker-color: " + pal.success + " !important;",
            "      --in-content-primary-button-background-hover: " + pal.surface2 + " !important;",
            "      --in-content-primary-button-text-color-hover: " + pal.text + " !important;",
            "      --in-content-primary-button-background: " + pal.background + " !important;",
            "      --in-content-primary-button-text-color: " + pal.text + " !important;",
            "    }",
            "",
            "    .card {",
            "      background-color: " + pal.surface0 + " !important;",
            "    }",
            "  }",
            "}"
        ];
        ...
        browserProc.command = [
            ...
            "-c",
            "set -e\n" +
            "theme_css=" + shellEscape(themeCss) + "\n" +
            "content_css=" + shellEscape(userContent) + "\n" +
            "user_js_block=" + shellEscape(userJs) + "\n" +
            "profile=" + shellEscape(zenBrowserProfilePath) + "\n" +
            "if [ -d \"$profile\" ]; then\n" +
            "  mkdir -p \"$profile/chrome\"\n" +
            "  printf '%s\\n' \"$theme_css\" > \"$profile/chrome/userChrome.css\"\n" +
            "  printf '%s\\n' \"$content_css\" > \"$profile/chrome/userContent.css\"\n" +
            "  if [ -f \"$profile/user.js\" ]; then\n" +
            "    tmp=\"$profile/user.js.tmp\"\n" +
            "    awk 'BEGIN{skip=0} /LYNE_THEME_BEGIN/{skip=1; next} /LYNE_THEME_END/{skip=0; next} !skip {print}' \"$profile/user.js\" > \"$tmp\"\n" +
            "  else\n" +
            "    tmp=\"$profile/user.js.tmp\"\n" +
            "    : > \"$tmp\"\n" +
            "  fi\n" +
    ...
    Process {
        id: browserProc
        stderr: SplitParser {
            onRead: data => console.error("[ThemeService:Browser] " + data)
        }
        onExited: exitCode => {
            if (exitCode === 0) {
                console.log("[ThemeService] Zen browser theme updated:", zenBrowserProfilePath);
            } else {
                console.error("[ThemeService] Zen browser theme update failed with exit code:", exitCode);
            }
        }
    }
        ...
        onExited: exitCode => {
            if (exitCode === 0) {
                try {
                    ...
                    // Apply browser theme files before the rest of the auto pipeline
                    root._applyBrowserTheme(root.palette);
