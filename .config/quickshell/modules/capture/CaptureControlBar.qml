    ...
    Row {
        ...
        Item {
            ...
            Rectangle {
                ...
                y: 3
                radius: height / 2
                color: root.screenshot.captureType === "recording" ? Config.errorColor : Config.accentColor
                x: 4 + (root.screenshot.captureTypes.indexOf(root.screenshot.captureType) * 44)
            ...
            Row {
                ...
                Repeater {
                    model: root.screenshot.captureTypes
                    ...
                    Item {
                        ...
                        Text {
                            anchors.centerIn: parent
                            text: root.screenshot.captureTypeIcons[modelData]
                            font.family: Config.font
                            font.pixelSize: Config.fontSizeIcon
                            color: root.screenshot.captureType === modelData ? Config.textReverseColor : Config.textColor
                        }

                        MouseArea {
                            anchors.fill: parent
                            cursorShape: Qt.PointingHandCursor
                            onClicked: root.screenshot.setCaptureType(modelData)
                        }
                    }
                }
            }
        ...
        Row {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        font.family: Config.font
                        font.pixelSize: Config.fontSizeIcon
                        color: confirmArea.containsMouse ? Config.textColor : (root.screenshot.captureType === "recording" ? Config.errorColor : Config.successColor)
                    }
            ...
            // Edit button
            Item {
                width: (root.screenshot.hasSelection && root.screenshot.captureType === "screenshot") ? 44 : 0
                height: 42
                visible: root.screenshot.hasSelection && root.screenshot.captureType === "screenshot"
                clip: true
